...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20240715105145_db_success_8")]
    partial class db_success_8
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.Colors", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("dc1b6c56-09a1-4928-9333-60f3e90894ec"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 15, 17, 51, 44, 830, DateTimeKind.Local).AddTicks(685),
                            Description = "",
                            Name = "White",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("48ee16ed-22a7-475f-abfd-1234f2b98979"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 15, 17, 51, 44, 830, DateTimeKind.Local).AddTicks(720),
                            Description = "",
                            Name = "Black",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("2ef62fd3-7d62-4378-b3ad-fa4de9c3a25d"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 15, 17, 51, 44, 830, DateTimeKind.Local).AddTicks(722),
                            Description = "",
                            Name = "Red",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("f2b6f63c-6618-4d6a-83e5-4c74236e68e4"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 15, 17, 51, 44, 830, DateTimeKind.Local).AddTicks(724),
                            Description = "",
                            Name = "Blue",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("85ad9a2e-80b5-4224-b0f4-2d85a733a800"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 15, 17, 51, 44, 830, DateTimeKind.Local).AddTicks(726),
                            Description = "",
                            Name = "Green",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.Sizes", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("6f1b0562-3684-465b-b856-b0de399709ea"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 15, 17, 51, 44, 830, DateTimeKind.Local).AddTicks(885),
                            Description = "",
                            Name = "XS",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("0ec36ef1-a167-4b6d-a5fc-d5d7720e2c2e"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 15, 17, 51, 44, 830, DateTimeKind.Local).AddTicks(887),
                            Description = "",
                            Name = "S",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("8704a78a-61fe-4f25-9540-47ca98f23b2c"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 15, 17, 51, 44, 830, DateTimeKind.Local).AddTicks(889),
                            Description = "",
                            Name = "M",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("15e16259-7427-4fb4-92ed-973b2d32b7ab"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 15, 17, 51, 44, 830, DateTimeKind.Local).AddTicks(892),
                            Description = "",
                            Name = "L",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("767c7ea9-177a-40b5-9238-62924c3e9035"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 15, 17, 51, 44, 830, DateTimeKind.Local).AddTicks(896),
                            Description = "",
                            Name = "XL",
                            Status = 1
                        });
