...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20240709042740_bswDB_1.1")]
    partial class bswDB_11
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.Colors", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("b93e2f4c-f18f-4a60-a278-80e975e02dba"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 9, 11, 27, 40, 97, DateTimeKind.Local).AddTicks(4846),
                            Description = "",
                            Name = "White",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("7e16458d-bfb5-4e87-9e01-9be91f1adea4"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 9, 11, 27, 40, 97, DateTimeKind.Local).AddTicks(4866),
                            Description = "",
                            Name = "Black",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("fca2c288-ce9a-4b7e-9c4b-f874b5360b40"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 9, 11, 27, 40, 97, DateTimeKind.Local).AddTicks(4868),
                            Description = "",
                            Name = "Red",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("3738576a-5151-4677-9c7d-560ebb9630b3"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 9, 11, 27, 40, 97, DateTimeKind.Local).AddTicks(4870),
                            Description = "",
                            Name = "Blue",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("76494ec6-5a62-467f-bfe1-2da3ca622c6a"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 9, 11, 27, 40, 97, DateTimeKind.Local).AddTicks(4885),
                            Description = "",
                            Name = "Green",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("DataAccessLayer.Entity.Sizes", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("925d3b32-0549-4484-a949-07ad234b15ef"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 9, 11, 27, 40, 150, DateTimeKind.Local).AddTicks(8875),
                            Description = "",
                            Name = "XS",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("755eb9c7-ad34-405e-9b8c-c939a4fe6598"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 9, 11, 27, 40, 150, DateTimeKind.Local).AddTicks(8898),
                            Description = "",
                            Name = "S",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("cad7735b-5be3-43a0-b147-c8922d530629"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 9, 11, 27, 40, 150, DateTimeKind.Local).AddTicks(8900),
                            Description = "",
                            Name = "M",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("1f08c6bc-f1e7-4dbd-ae41-aaaa531375c0"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 9, 11, 27, 40, 150, DateTimeKind.Local).AddTicks(8902),
                            Description = "",
                            Name = "L",
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("e13bb112-baf9-4e91-b8b5-680293e71f70"),
                            CreateBy = "",
                            CreateDate = new DateTime(2024, 7, 9, 11, 27, 40, 150, DateTimeKind.Local).AddTicks(8904),
                            Description = "",
                            Name = "XL",
                            Status = 1
                        });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1e979495-3e52-48c6-b92f-9aa4c3ed7908",
                            Name = "Admin",
                            NormalizedName = "Admin"
                        },
                        new
                        {
                            Id = "4d274d3a-ab13-43d3-9472-b6b2c6bdafdf",
                            Name = "Client",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "a76b9a0f-73bb-4f9a-8233-c5074336dd25",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "dba83d9c-09e1-46c2-a917-ed290c3a47ec",
                            Email = "admin@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "admin@gmail.com",
                            NormalizedUserName = "admin",
                            PasswordHash = "AQAAAAIAAYagAAAAEK6OyANqdhdu6up4220JUOibl5deRcd/k32d2WgVK1srRztu0xRU8qYTzGciNMw+fg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "29ff3605-b4be-408f-ae0d-f2b1effd2007",
